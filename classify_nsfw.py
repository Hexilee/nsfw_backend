...
default_model_def = 'nsfw_model/deploy.prototxt'
...
def test_score(model_def, pretrained_model, image_data):
...
if __name__ == '__main__':
    for i in range(13):
        print 'score%d: %f' % (i + 1, test_score(default_model_def, default_pretrained_model,
                                                 open('img/test%d.jpg' % (i + 1)).read()))
